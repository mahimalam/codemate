...
export function App() {
  ...
  return <div className="app-shell">
    ...
    <footer className="statusbar"><span><GitBranch />{workspace?.has_workspace ? workspace.short_path : 'No workspace'}</span><span className="status-spacer" /><span><Command />UTF-8</span><span>{active ? languageForPath(active.path) : 'VexP Harness'}</span></footer>
